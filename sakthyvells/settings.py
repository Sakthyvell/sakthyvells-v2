"""
Django settings for sakthyvells project.
...
# To get the relevant errors to propagate up through the Heroku logs
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'blog.context_processors.categoryList'
            ],
        },
    },
]

WSGI_APPLICATION = 'sakthyvells.wsgi.application'
...
if USE_S3:
    ...
    STATICFILES_STORAGE = 'sakthyvells.storage_backends.StaticStorage'
    # s3 public media settings
    PUBLIC_MEDIA_LOCATION = 'media'
    MEDIA_URL = f'https://{AWS_S3_CUSTOM_DOMAIN}/{PUBLIC_MEDIA_LOCATION}/'
    DEFAULT_FILE_STORAGE = 'sakthyvells.storage_backends.MediaStorage'
else:
